...
func attributesToJSONMapString(event string, attributes []attribute.KeyValue) string {
	if len(attributes) == 1 && attributes[0].Key == "data" {
		m := map[string]interface{}{
			event: attributes[0].Value.AsInterface(),
		}
